...
public class drawInterface extends JComponent {
    ...
    public void drawBot(int x, int y, double scl, int c1, int c2, int c3, Graphics g, int tx, int ty) {
        fill(c1, c2, c3, g);
        rect((int)x, (int)(y - 12*scl), (int)(17*scl), (int)(17*scl), g, tx, ty);
        rect((int)x, y, (int)(10*scl), (int)(10*scl), g, tx, ty);
        rect((int)x, (int)(y + 24.0*scl), (int)(23*scl), (int)(40*scl), g, tx, ty);
    ...
    public void drawChemical(int x, int y, Graphics g, int c1, int c2, int c3, int c4, int c5, int c6, int tx, int ty, int scl) {
        fill(200, 200, 200, 100, g);
        rect(x, y - 8*scl, 10*scl, 25*scl, g, tx, ty);
        
        fill(c1, c2, c3, 200, g);
        
        ellipse(x, y + 2*scl, 10*scl, 12*scl, g, tx, ty);
        
        fill(200, 200, 200, 200, g);
        strokeWeight(3*scl, g);
        ellipseOutline(x, y + 2*scl, 10*scl, 12*scl, g, tx, ty);
        
        fill(c1, c2, c3, 200, g);
        
        rect(x, y - 2*scl, 10*scl, 10*scl, g, tx, ty);
        
        fill(c4, c5, c6, 200, g);
        
        rect(x, y - 10*scl, 10*scl, 10*scl, g, tx, ty);
        
        fill(200, 200, 200, 200, g);
        double fc = 1.75;
        line(x - 5*scl, y - 19*scl, x - 5*scl, y + (int)(fc*scl), g, tx, ty);
        line(x + 5*scl, y - 19*scl, x + 5*scl, y + (int)(fc*scl), g, tx, ty);
    }
